                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="flex gap-4">
                        ...
                        <div className="w-1/2 md:w-full h-auto md:h-[600px] overflow-hidden">
                            <div className="hidden md:flex md:flex-col md:space-y-4 md:animate-teleportScroll">
                        ...
                        {/* Coluna 2 */}
                        <div className="w-1/2 md:w-full h-auto md:h-[600px] overflow-hidden">
                            <div className="hidden md:flex md:flex-col md:space-y-4 md:animate-teleportScroll md:animation-delay-7500">
