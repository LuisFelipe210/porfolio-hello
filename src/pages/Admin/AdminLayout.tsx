...
import { useIsMobile } from '@/hooks/use-mobile'; // Importe o hook
...
const AdminPortfolio = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            console.error(error);
            toast({ variant: 'destructive', title: 'Erro', description: error.message || 'Não foi possível adicionar o item.' });
        } finally {
