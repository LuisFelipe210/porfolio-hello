...
const ClientLayout = () => {
    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <header className="sticky top-0 z-[100] flex h-20 md:h-24 items-center justify-between bg-white/10 backdrop-blur-lg text-gray-200 shadow-md border-b border-white/20 px-4 md:px-12 relative">
