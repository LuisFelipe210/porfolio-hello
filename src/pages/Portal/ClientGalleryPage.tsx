            ...
            {!isSelectionComplete && (
                <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 animate-slide-in-from-bottom-5">
                    <div className="flex items-center gap-4 px-3 py-3 sm:px-6 sm:py-4 bg-black/70 backdrop-blur-xl border border-white/10 rounded-full shadow-2xl">
                        ...
                        <AlertDialog>
                            <AlertDialogTrigger asChild><Button size="lg" disabled={selectedImages.size === 0} className="bg-orange-500 hover:bg-orange-600 text-white font-semibold rounded-full disabled:opacity-50 h-12 text-base"><Send className="mr-2 h-4 w-4" /> Finalizar</Button></AlertDialogTrigger>
